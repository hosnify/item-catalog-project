...
engineering = Category(
    name='Engineering',
    description='Courses for Engineering students',
    author=user)
language = Category(
    name='Language Learning',
    description='Courses for Language students',
    author=user)
business = Category(
    name='Business',
    description='Courses for Business students',
    author=user)
...
course_1 = Course(
    name='Marketing',
    description='Learn principles of marketing',
    author=user,
    category=business,
    price=100)
course_2 = Course(
    name='Corporate Finance',
    description='Learn key financial concepts ',
    author=user,
    category=business,
    price=250)
course_3 = Course(
...
course_5 = Course(
    ...
    description='The sounds of English and International Phonetic Alphabet',
    author=user,
    category=language,
    price=100)
course_6 = Course(
    name='Chinese for Beginners',
    description='introduction of phonetics and daily expressions in Chinese',
    author=user,
    category=language,
    price=200)
